...
class LoadVerticaTableFromS3ToSnowflake(LoadVerticaTableFromS3ToSnowflakeMixin, SnowflakeLoadTask):
    ...
    def insert_source_task(self):
        ...
        workflow, so we specify ExternalURL here instead. In the future we can change this to a SqoopImportFromVertica task.
        """
...
class VerticaSchemaToSnowflakeTask(LoadVerticaTableFromS3ToSnowflakeMixin, SnowflakeLoadDownstreamMixin, luigi.WrapperTask):
    """
